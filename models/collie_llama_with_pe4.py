...
class LlamaLayer(nn.Module):
    ...
    def forward(self, inputs: dict):
        ...
        # pre_time = cur_time
        if f"past_key_values_layer{self.idx}_key" in inputs and f"past_key_values_layer{self.idx}_value" in inputs:
            layer_past = (inputs[f"past_key_values_layer{self.idx}_key"], 
                          inputs[f"past_key_values_layer{self.idx}_value"]) 
        else:
            layer_past = None
