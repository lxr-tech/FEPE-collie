...
#  --dim='2d' --exp='rope' --imp='inv' --log='raw' --tag='rope_inv_2d_raw_cl' --group='flash_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe_hf.py --model_size='330M' --max_length=512 \
#  --dim='2d' --exp='xpos' --imp='inv' --log='raw' --tag='xpos_inv_2d_raw_cl' --group='flash_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe_hf.py --model_size='330M' --max_length=512 \
#  --dim='1d' --exp='xpos' --imp='imp' --log='raw' --tag='xpos_imp_1d_raw_cl' --group='flash_fepe_collie'

# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='1d' --exp='xpos' --imp='imp' --log='raw' --tag='xpos_imp_1d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='1d' --exp='xpos' --imp='inv' --log='raw' --tag='xpos_inv_1d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='2d' --exp='xpos' --imp='imp' --log='raw' --tag='xpos_imp_2d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='2d' --exp='xpos' --imp='inv' --log='raw' --tag='xpos_inv_2d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='1d' --exp='rope' --imp='imp' --log='raw' --tag='rope_imp_1d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='1d' --exp='rope' --imp='inv' --log='raw' --tag='rope_inv_1d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='2d' --exp='rope' --imp='imp' --log='raw' --tag='rope_imp_2d_raw' --group='debug5_fepe_collie'
# wait
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_backend=c10d --rdzv_endpoint=localhost:29402 \
#  --nnodes=1 --nproc_per_node=4 train_pe.py --model_size='330M' --max_length=512 \
#  --dim='2d' --exp='rope' --imp='inv' --log='raw' --tag='rope_inv_2d_raw' --group='debug5_fepe_collie'
