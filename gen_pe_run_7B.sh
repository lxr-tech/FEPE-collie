srun -p llm_t --ntasks=16 --ntasks-per-node=8 --gres=gpu:8 --quotatype=reserved \
 --kill-on-bad-exit=1 -w HOST-10-140-66-[180-181] python gen_pe.py --task_a='finetune' --task_b='testing' \
 ...
 --tag='base_500_new' --path='hang_500' --group='llama2_7B_gen_48k' --pp_size=2
# wait
