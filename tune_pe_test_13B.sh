...
#  --kill-on-bad-exit=1 -w HOST-10-140-66-[105-108] python tune_pe.py --task_a='finetune' --task_b='testing' \
#  --model_size='llama2-13B' --max_length=4096 --dataset='pile' --ext_length='100k' \
#  --dim='2d' --exp='rope' --imp='inv' --ln='raw' --log_base=4096 --exp_base=4096 \
#  --base=10000 --pi_lambda=1 --ntk_option='fixed' --ntk_alpha=8 \
#  --tag='ntk_fixed_8' --path='llama2-13B' --group='llama2_13B_100k' --pp_size=4
# wait
# srun -p llm_t --ntasks=32 --ntasks-per-node=8 --gres=gpu:8 --quotatype=reserved \
#  --kill-on-bad-exit=1 -w HOST-10-140-66-[105-108] python tune_pe.py --task_a='finetune' --task_b='testing' \
#  --model_size='llama2-13B' --max_length=4096 --dataset='pile' --ext_length='100k' \
...
#  --tag='-' --path='llama2-13B' --group='llama2_13B_100k' --pp_size=4
